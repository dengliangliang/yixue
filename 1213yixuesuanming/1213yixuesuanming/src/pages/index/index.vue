<template>
	<view class="content">
		...
		<view class="theme-container animate__animated animate__fadeInDown animate__delay-0-8s">
			<!-- 主题文案图片 -->
			<image src="/static/jiemi.png" class="theme-image" mode="widthFix"></image>
		</view>
		...
		<!-- 按钮 -->
		 <view class="btn-container animate__animated animate__zoomIn animate__delay-1s">
			<!-- 按钮图片 -->
			<image src="/static/anniu.png" class="explore-btn-image" mode="widthFix" @click="navto"></image>
		</view>
	</view>
	...
	<uni-popup ref="introPopup" type="center" :mask-click="false">
		<view class="intro-popup-container">
			<!-- 透明暗纹图片 -->
			<image src="/static/yun1.png" class="intro-watermark watermark-top-left" mode="widthFix"></image>
			<image src="/static/yun2.png" class="intro-watermark watermark-bottom-right" mode="widthFix"></image>
			<image src="/static/yun1.png" class="intro-watermark watermark-title-under" mode="widthFix"></image>
			<image src="/static/yun2.png" class="intro-watermark watermark-center" mode="widthFix"></image>
	...
	export default {
		...
		async checkReturnUser() {
			try {
				...
				if (!customerId) {
					console.log('[index] 未找到客户号,为新用户');
					return;
				}
				
				console.log('[index] 检测到客户号:', customerId);
